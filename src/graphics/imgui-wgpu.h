// cimgui doesn't contain bindings for imgui's wgpu or sdl3 backends, so this header exists in its place
#pragma once
#include <webgpu.h>
...
CIMGUI_API void ImGui_ImplWGPU_Shutdown();
CIMGUI_API void ImGui_ImplWGPU_NewFrame();
CIMGUI_API void ImGui_ImplWGPU_RenderDrawData(ImDrawData* draw_data, WGPURenderPassEncoder pass_encoder);

// Use if you want to reset your rendering device without losing Dear ImGui state.
CIMGUI_API void ImGui_ImplWGPU_InvalidateDeviceObjects();
CIMGUI_API bool ImGui_ImplWGPU_CreateDeviceObjects();
...
CIMGUI_API void     ImGui_ImplSDL3_SetGamepadMode(ImGui_ImplSDL3_GamepadMode mode, SDL_Gamepad** manual_gamepads_array/* = NULL*/, int manual_gamepads_count/* = -1*/);

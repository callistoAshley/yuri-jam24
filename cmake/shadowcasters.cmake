...
add_custom_target(shadowcasters ALL DEPENDS shadowcast)
function(add_shadowcaster target)
  if (${ARGC} EQUAL 1)
    add_custom_command(
      ...
      COMMAND ${CMAKE_CURRENT_BINARY_DIR}/shadowcast ${CMAKE_SOURCE_DIR}/assets/textures/${target}.png ${CMAKE_SOURCE_DIR}/assets/shadowcasters/${target}.shdw
    ...
    add_custom_command(
      ...
      #OUTPUT ${CMAKE_SOURCE_DIR}/assets/shadowcasters/${target}.shdw
      COMMAND ${CMAKE_CURRENT_BINARY_DIR}/shadowcast ${CMAKE_SOURCE_DIR}/assets/textures/${target}.png ${CMAKE_SOURCE_DIR}/assets/shadowcasters/${target}.shdw ${ARGV1} ${ARGV2}
      COMMAND echo "Generated shadowcaster for ${target}"
    )
  endif()
